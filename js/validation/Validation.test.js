...
test('pavarde ivesta teisingai', () => {
    expect(v.isValidLastName('Gaidukis')).toBe(true);
})
...
test('geras numeris', () => {
    expect(v.isValidPhoneNumber('+37060973717')).toBe(true);
})

test('numeris neprasideda +', () => {
    expect(v.isValidPhoneNumber('37060973717')).toBe(false);
})
test('numeris tuscias laukas', () => {
    expect(v.isValidPhoneNumber('')).toBe(false);
})
test('numer', () => {
    expect(v.isValidPhoneNumber('37060973717')).toBe(false);
})